...
export default function Navbar() {
  ...
  return (
    <div className="sticky top-0 z-50 grid w-full bg-white dark:border-b dark:bg-zinc-900/70 backdrop-blur-lg text-zinc-900 dark:text-zinc-300 place-items-center dark:border-zinc-800">
      ...
      />
      <div className="relative flex items-center justify-between w-full max-w-screen-xl p-4 mx-auto">
        <div
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            <Tooltip
              ...
              placement="bottom"
              content={
                <div className="grid grid-cols-2 gap-4 p-5 pb-2 font-Roboto">
          ...
          {user ? (
            <Dropdown placement="bottom-end" className="text-xs font-Roboto">
              <DropdownTrigger>
            ...
            <Tooltip
              ...
              placement="bottom"
              content={
                <div className="w-[250px] p-5 pb-8 font-Roboto">
          ...
          <Dropdown className="font-Roboto">
            <DropdownTrigger>
      ...
      {navLinks.map((link) => (
        <div className="relative">
          <NavLink
            key={link.to}
            to={link.to}
            className={`text-[12.5px] hover:brightness-125`}
          >
            {link.label}
          </NavLink>
        </div>
