export const QuickSearchData = [
  ...
  {
    name: "Code Editor",
    link: "/learn-js/code-editor",
    description: `Experience a user-friendly and rapid JavaScript compiler.
Write and run JavaScript code online effortlessly.`,
  },
  {
    name: "Online Compiler",
    link: "/learn-js/code-editor",
    description: `CodeScript Online Editor`,
  },
  {
    name: "Leaderboards",
    link: "/learn-js/leaderboard",
    description: `View who are the top users in CodeScript.`,
  },
  {
    name: "Introduction",
    link: "/learn-js/intro",
  ...
  {
    name: "Conditionals",
    link: "/learn-js/conditionals",
    description: "Conditionals in JavaScript",
  },
  {
    name: "if",
    link: "/learn-js/conditionals",
    description: "if in JavaScript",
  },
  {
    name: "if else",
    link: "/learn-js/conditionals",
    description: "if else in JavaScript",
  },
  {
    name: "else if",
    link: "/learn-js/conditionals",
    description: "else if in JavaScript",
  },
  {
