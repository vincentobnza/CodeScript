...
import { Zap, Blocks, FlaskConical } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <motion.div
      ...
      className="relative w-full pb-10 space-y-4 overflow-hidden bg-white dark:bg-zinc-900 text-zinc-700 dark:text-zinc-400 md:space-y-14"
    >
      <Hero />
      <Main />
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-screen-lg gap-6 p-4 mx-auto text-center md:p-8 lg:p-8">
      ...
      <div className="flex items-center gap-2">
        <Link
          to="/learn"
          className="z-10 flex items-center justify-center gap-2 w-[120px] py-2 mt-10 text-xs tracking-wide text-green-600 bg-transparent dark:text-green-200 border border-green-500  dark:bg-gradient-to-br dark:from-green-600/30 dark:to-green-600/40 md:px-4 md:py-[0.60rem] md:text-md hover:brightness-125"
        >
          Learn JS
          <Blocks size={16} />
        </Link>
        <Link
          to="/code-lab"
          className="z-10 flex items-center justify-center gap-2 w-[120px] py-2 mt-10 text-xs tracking-wide text-zinc-700 bg-transparent dark:text-white border border-zinc-500  dark:bg-gradient-to-br dark:from-zinc-600/30 dark:to-zinc-600/40 md:px-4 md:py-[0.60rem] md:text-md hover:brightness-125"
        >
          Code Lab
  ...
  return (
    <div className="grid w-full max-w-screen-lg gap-6 p-5 mx-auto md:grid-cols-2 md:p-0">
      <div className="flex flex-col w-full mt-4 md:mt-16">
        ...
        <Link
          to="/code-editor"
          className="self-start px-10 py-3 mt-8 text-sm font-bold transition-opacity duration-500 ease-in-out bg-transparent border rounded-full shadow-none dark:shadow-2xl text-zinc-700 dark:text-zinc-300 dark:bg-zinc-800 border-zinc-300 dark:border-zinc-700 hover:bg-transparent hover:text-green-400 dark:hover:text-green-500 hover:border-green-300 dark:hover:border-green-600"
        >
          Get Started
        </Link>
      </div>
