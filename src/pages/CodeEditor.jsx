...
export default function CodeScript() {
  ...
  return (
    <div className="flex flex-col w-full h-screen font-Balsamiq bg-zinc-900 md:flex-row">
      <Toaster />
      <AssessmentSidePanel
    ...
    <div className="relative p-6 h-full bg-[#1E1E1E] text-zinc-300 overflow-y-auto">
      ...
      <div className="w-full">
        ...
        <div className="w-full p-3 overflow-y-auto border rounded text-zinc-300 h-28 bg-zinc-800 border-zinc-600">
          <pre className="text-sm whitespace-pre-wrap font-Balsamiq">
          ...
          >
            <div className="flex flex-col w-full gap-2 mt-8 overflow-hidden overflow-y-auto text-sm">
              ...
              <div className="w-full p-3 mt-2 text-sm text-green-100 border border-green-600 rounded bg-green-700/20">
                <p className="leading-relaxed whitespace-pre-wrap font-Balsamiq">
                  {assessment.hint}
                </p>
              </div>
            </div>
